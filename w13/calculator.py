...
# to add title. use the .title()
root.title("Simple Calculator")

e = Entry(root, width=10, borderwidth=5, font=large_font)
...
# define buttons
# using lambda: so we can enter the function with () and pass argument
...
# Change decimal # add history? # scalable